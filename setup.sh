...
run_arch() {
    ...
    # ---------------------------------------------------------------------------
    info "1/9  System packages (mpd ffmpeg cava yt-dlp wl-clipboard)"
    # wl-clipboard: Ctrl+V / middle-click read the clipboard through wl-paste
    # (src/core/input.rs; xclip/xsel are the fallbacks). Bracketed paste and
    # drag & drop work without it, but a removal silently kills Ctrl+V.
    PACMAN_PKGS=(mpd ffmpeg cava yt-dlp wl-clipboard)
    MISSING=()
...
run_dnf5() {
    ...
    info "1/9  System packages (mpd mpdris2 cava yt-dlp mpv ffmpeg wl-clipboard python3-dbus python3-gobject python3-mutagen + toolchain)"
    ...
    DNF5_PKGS=(mpd mpdris2 cava yt-dlp mpv ffmpeg wl-clipboard python3-dbus python3-gobject python3-mutagen gcc make git curl)
    MISSING=()
...
run_apt() {
    ...
    info "1/9  System packages (mpd mpdris2 cava yt-dlp mpv ffmpeg wl-clipboard python3-dbus python3-gi python3-mutagen + toolchain)"
    APT_PKGS=(mpd mpdris2 cava yt-dlp mpv ffmpeg wl-clipboard python3-dbus python3-gi python3-mutagen build-essential git curl)
    MISSING=()
...
run_apk() {
    ...
    info "1/9  System packages (mpd mpv yt-dlp ffmpeg wl-clipboard python3 py3-dbus py3-gobject3 + toolchain; cava from source)"
    APK_PKGS=(mpd mpv yt-dlp ffmpeg wl-clipboard python3 py3-dbus py3-gobject3 py3-mutagen py3-pip build-base git curl fftw-dev iniparser-dev ncurses-dev sdl2-dev autoconf automake libtool ncurses-terminfo-base)
    MISSING=()
...
run_xbps() {
    ...
    info "1/9  System packages (mpd mpv yt-dlp cava ffmpeg wl-clipboard mpDris2 python3-dbus python3-gobject + toolchain)"
    ...
    XBPS_PKGS=(mpd mpv yt-dlp cava ffmpeg wl-clipboard mpDris2 python3 python3-dbus python3-gobject python3-mutagen python3-mpd2 base-devel cargo rust git curl util-linux procps-ng ncurses-term runit)
    MISSING=()
