...
use crate::mpd::{
    QueuePosition,
    commands::{
        IdleEvent, ListFiles, LsInfo, Playlist, Song, Status, Update, Volume, list::MpdList,
        list_all::ListAll, list_playlist::FileList, metadata_tag::MetadataTagExt,
        mpd_config::MpdConfig, status::OnOffOneshot, stickers::Sticker, volume::Bound,
    },
    errors::MpdError,
    mpd_client::{
        AlbumArtOrder, Filter, MpdClient, SaveMode, SingleOrRange, StickerFilter,
        StringNormalizationFeature, Tag, ValueChange,
    },
...
impl MpdClient for TestMpdClient {
    ...
    fn add_id(&mut self, _uri: &str, _position: Option<QueuePosition>) -> MpdResult<u32> {
        todo!("Not yet implemented")
    }
    ...
    fn add_tag_id(&mut self, _id: u32, _tag: &str, _value: &str) -> MpdResult<()> {
        todo!("Not yet implemented")
    }
