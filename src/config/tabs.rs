...
use ratatui::{
    layout::Direction, style::{Color, Style},
...
use crate::{
    config::{
        ...
        theme::{
            ...
            borders::{
                BorderSetInherited, BorderSetLib, BorderSymbols, BorderSymbolsFile,
            },
...
pub enum PaneTypeFile {
    ...
    Albums,
    AlbumArtists,
    Playlists { #[serde(default)] tree: TreeBrowserArgs },
    Search,
    Radio { #[serde(default)] tree: TreeBrowserArgs },
    Jellyfin { #[serde(default)] tree: TreeBrowserArgs },
    AlbumArt,
    Lyrics,
    ProgressBar,
    Volume { #[serde(default)] kind: VolumeTypeFile },
    Controls,
    Header,
    Tabs,
    TabContent,
    ...
    Browser { root_tag: String, separator: Option<String> },
    Cava,
    Empty(),
}
...
fn fix_zero_tuple_variants(content: Content<'_>) -> Content<'_> {
    match content {
        ...
        Content::Newtype(value) => {
            Content::Newtype(Box::new(fix_zero_tuple_variants(*value)))
        }
...
impl<'de> Deserialize<'de> for PaneTypeFile {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        match content {
            ...
            content => {
                PaneTypeFileArgs::deserialize(
                        ContentDeserializer::<
                            serde::de::value::Error,
                        >::new(fix_zero_tuple_variants(content)),
                    )
                    .map(Into::into)
...
pub enum PaneType {
    ...
    AlbumArtists,
    Albums,
    Playlists { tree: TreeBrowserArgs },
    Search,
    Radio { tree: TreeBrowserArgs },
    Jellyfin { tree: TreeBrowserArgs },
    AlbumArt,
    Lyrics,
    ProgressBar,
    Volume { kind: VolumeType },
    Controls,
    Header,
    Tabs,
    TabContent,
    ...
    fn try_from(value: PaneTypeFile) -> Result<PaneType, Self::Error> {
        Ok(
            match value {
                ...
                PaneTypeFile::Volume { kind } => {
                    PaneType::Volume {
                        kind: match kind {
                            VolumeTypeFile::Slider(cfg) => {
                                VolumeType::Slider(cfg.into_config()?)
                            }
                        },
                    }
                }
...
impl Default for PaneOrSplitFile {
    fn default() -> Self {
        PaneOrSplitFile::Split {
            ...
            panes: vec![
                SubPaneFile { collapse_below : None, shrink_below : None, window_sizes :
                Vec::new(), size : "4".to_string(), background_color : None, borders :
                BordersFile::NONE, border_style : None, border_active_style : None,
                border_title : Vec::new(), border_title_position :
                BorderTitlePosition::Top, border_title_alignment : Alignment::Left,
                border_symbols : BorderSymbolsFile::default(), pane :
                PaneOrSplitFile::Split { direction : DirectionFile::Horizontal, borders :
                BordersFile::NONE, panes : vec![SubPaneFile { collapse_below : None,
                shrink_below : None, window_sizes : Vec::new(), size : "35".to_string(),
                background_color : None, borders : BordersFile::LEFT | BordersFile::TOP |
                BordersFile::BOTTOM, border_style : None, border_active_style : None,
                border_title : Vec::new(), border_title_position :
                BorderTitlePosition::Top, border_title_alignment : Alignment::Left,
                border_symbols : BorderSymbolsFile::Inherited(BorderSetInherited { parent
                : Box::new(BorderSymbolsFile::Rounded), bottom_left : Some("├"
                .to_string()), ..Default::default() }), pane :
                PaneOrSplitFile::Component("header_left".to_string()), }, SubPaneFile {
                collapse_below : None, shrink_below : None, window_sizes : Vec::new(),
                size : "100%".to_string(), background_color : None, borders :
                BordersFile::ALL, border_style : None, border_active_style : None,
                border_title : Vec::new(), border_title_position :
                BorderTitlePosition::Top, border_title_alignment : Alignment::Left,
                border_symbols : BorderSymbolsFile::Inherited(BorderSetInherited { parent
                : Box::new(BorderSymbolsFile::Rounded), top_left : Some("┬"
                .to_string()), top_right : Some("┬".to_string()), bottom_left :
                Some("┴".to_string()), bottom_right : Some("┴".to_string()),
                ..Default::default() }), pane :
                PaneOrSplitFile::Component("header_center".to_string()), }, SubPaneFile {
                collapse_below : None, shrink_below : None, window_sizes : Vec::new(),
                size : "35".to_string(), background_color : None, borders :
                BordersFile::RIGHT | BordersFile::TOP | BordersFile::BOTTOM, border_style
                : None, border_active_style : None, border_title : Vec::new(),
                border_title_position : BorderTitlePosition::Top, border_title_alignment
                : Alignment::Left, border_symbols :
                BorderSymbolsFile::Inherited(BorderSetInherited { parent :
                Box::new(BorderSymbolsFile::Rounded), bottom_right : Some("┤"
                .to_string()), ..Default::default() }), pane :
                PaneOrSplitFile::Component("header_right".to_string()), },], }, },
                SubPaneFile { collapse_below : None, shrink_below : None, window_sizes :
                Vec::new(), size : "2".to_string(), background_color : None, borders :
                BordersFile::LEFT | BordersFile::RIGHT | BordersFile::BOTTOM,
                ...
                PaneOrSplitFile::Pane(PaneTypeFile::Tabs), }, SubPaneFile {
                collapse_below : Some(15), shrink_below : None, window_sizes :
                Vec::new(), size : "100%".to_string(), background_color : None, borders :
                BordersFile::NONE, border_style : None, border_active_style : None,
                border_title : Vec::new(), border_title_position :
                BorderTitlePosition::Top, border_title_alignment : Alignment::Left,
                border_symbols : BorderSymbolsFile::default(), pane :
                PaneOrSplitFile::Pane(PaneTypeFile::TabContent), }, SubPaneFile {
                collapse_below : None, shrink_below : None, window_sizes : Vec::new(),
                size : "3".to_string(), background_color : None, borders :
                BordersFile::NONE, border_style : None, border_active_style : None,
                border_title_position : BorderTitlePosition::Top, border_title_alignment
                : Alignment::Left, border_title : Vec::new(), border_symbols :
                BorderSymbolsFile::default(), pane : PaneOrSplitFile::Split { direction :
                DirectionFile::Horizontal, borders : BordersFile::NONE, panes :
                vec![SubPaneFile { collapse_below : None, shrink_below : None,
                window_sizes : Vec::new(), size : "12".to_string(), background_color :
                None, borders : BordersFile::ALL, border_style : None,
                border_active_style : None, border_title : Vec::new(),
                border_title_position : BorderTitlePosition::Top, border_title_alignment
                : Alignment::Left, border_symbols :
                BorderSymbolsFile::Inherited(BorderSetInherited { parent :
                Box::new(BorderSymbolsFile::Rounded), top_right : Some("┬"
                .to_string()), bottom_right : Some("┴".to_string()),
                ..Default::default() }), pane : PaneOrSplitFile::Component("input_mode"
                .to_string()), }, SubPaneFile { collapse_below : None, shrink_below :
                None, window_sizes : Vec::new(), size : "100%".to_string(),
                background_color : None, borders : BordersFile::TOP | BordersFile::BOTTOM
                | BordersFile::RIGHT, border_style : None, border_active_style : None,
                border_title_alignment : Alignment::Right, border_symbols :
                BorderSymbolsFile::Rounded, border_title_position :
                BorderTitlePosition::Top, border_title : vec![PropertyFile { kind :
                PropertyKindFileOrText::Text(" ".to_string()), style : None, default :
                None, }, PropertyFile { kind :
                PropertyKindFileOrText::Property(PropertyKindFile::Status(StatusPropertyFile::QueueLength
                { thousands_separator : defaults::default_thousands_separator(), },),),
                style : None, default : None, }, PropertyFile { kind :
                PropertyKindFileOrText::Text(" songs / ".to_string()), style : None,
                default : None, }, PropertyFile { kind :
                PropertyKindFileOrText::Property(PropertyKindFile::Status(StatusPropertyFile::QueueTimeTotal
                { separator : None, },),), style : None, default : None, }, PropertyFile
                { kind : PropertyKindFileOrText::Text(" total time ".to_string(),), style
                : None, default : None, },], pane :
                PaneOrSplitFile::Component("progress_bar".to_string()), },], }, },
            ],
        }
    }
}
...
bitflags! {
    #[derive(Debug, Default, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)] pub
    struct BordersFile : u8 { const NONE = 0b0000; const TOP = 0b0001; const RIGHT =
    0b0010; const BOTTOM = 0b0100; const LEFT = 0b1000; const ALL = Self::TOP.bits() |
    Self::RIGHT.bits() | Self::BOTTOM.bits() | Self::LEFT.bits(); }
}
...
impl PaneOrSplitFile {
    ...
    pub fn convert_recursive(
        ...
        Ok(
            match self {
                PaneOrSplitFile::Pane(pane_type_file) => {
                ...
                PaneOrSplitFile::Component(name) => {
                    match library.get(name) {
                        ...
                        None => {
                            return Err(
                                PaneConversionError::MissingComponent(name.clone()),
                            );
                        }
                    }
                }
                PaneOrSplitFile::Split { direction, borders, panes } => {
                    SizedPaneOrSplit::Split {
                        ...
                        panes: panes
                            ...
                            .map(|sub_pane| -> Result<SizedSubPane, PaneConversionError> {
                                ...
                                let b_symbols = sub_pane
                                    .border_symbols
                                    .clone()
                                    .into_symbols(border_set_library)?;
                                let pane = sub_pane
                                    .pane
                                    .convert_recursive(
                                        background_color,
                                ...
                                let window_sizes = sub_pane
                                    ...
                                    .map(|
                                        (height, size),
                                    | -> Result<(u16, PercentOrLength), ParseSizeError> {
...
impl Default for TabsFile {
    fn default() -> Self {
        Self(
            vec![
                TabFile { name : "Local".to_string(), border_type : BorderTypeFile::None,
                pane : PaneOrSplitFile::Split { direction : DirectionFile::Horizontal,
                borders : BordersFile::NONE, panes : vec![SubPaneFile { collapse_below :
                None, shrink_below : None, window_sizes : Vec::new(), size : "35%"
                .to_string(), background_color : None, borders : BordersFile::NONE,
                border_style : None, border_active_style : None, border_title :
                Vec::new(), border_title_position : BorderTitlePosition::Top,
                border_title_alignment : Alignment::Left, border_symbols :
                BorderSymbolsFile::default(), pane : PaneOrSplitFile::Split { direction :
                DirectionFile::Vertical, borders : BordersFile::NONE, panes :
                vec![SubPaneFile { collapse_below : None, shrink_below : None,
                window_sizes : Vec::new(), pane :
                PaneOrSplitFile::Pane(PaneTypeFile::AlbumArt), background_color : None,
                size : "100%".to_string(), borders : BordersFile::TOP | BordersFile::LEFT
                | BordersFile::RIGHT, border_style : None, border_active_style : None,
                border_title_position : BorderTitlePosition::Top, border_title_alignment
                : Alignment::Left, border_symbols : BorderSymbolsFile::Rounded,
                border_title : Vec::new(), }, SubPaneFile { collapse_below : None,
                shrink_below : None, window_sizes : Vec::new(), pane :
                PaneOrSplitFile::Pane(PaneTypeFile::Lyrics), background_color : None,
                size : "7".to_string(), border_title : vec![PropertyFile { kind :
                PropertyKindFileOrText::Text(" Lyrics ".to_string(),), style : None,
                default : None, }], borders : BordersFile::ALL, border_style : None,
                border_active_style : None, border_title_position :
                BorderTitlePosition::Top, border_title_alignment : Alignment::Right,
                border_symbols : BorderSymbolsFile::Inherited(BorderSetInherited { parent
                : Box::new(BorderSymbolsFile::Rounded), top_left : Some("├"
                .to_string()), top_right : Some("┤".to_string()), ..Default::default()
                },), },], }, }, SubPaneFile { collapse_below : None, shrink_below : None,
                window_sizes : Vec::new(), size : "65%".to_string(), background_color :
                None, borders : BordersFile::NONE, border_style : None,
                border_active_style : None, border_title : Vec::new(),
                border_title_position : BorderTitlePosition::Top, border_title_alignment
                : Alignment::Left, border_symbols : BorderSymbolsFile::default(), pane :
                PaneOrSplitFile::Split { direction : DirectionFile::Vertical, borders :
                BordersFile::NONE, panes : vec![SubPaneFile { collapse_below : None,
                shrink_below : None, window_sizes : Vec::new(), size : "3".to_string(),
                background_color : None, borders : BordersFile::ALL, border_style : None,
                border_active_style : None, border_title : Vec::new(),
                border_title_position : BorderTitlePosition::Top, border_title_alignment
                : Alignment::Left, border_symbols :
                BorderSymbolsFile::Inherited(BorderSetInherited { parent :
                Box::new(BorderSymbolsFile::Rounded), bottom_left : Some("├"
                .to_string()), bottom_right : Some("┤".to_string()),
                ..Default::default() },), pane : PaneOrSplitFile::Split { direction :
                DirectionFile::Horizontal, borders : BordersFile::NONE, panes :
                vec![SubPaneFile { collapse_below : None, shrink_below : None,
                window_sizes : Vec::new(), pane :
                PaneOrSplitFile::Pane(PaneTypeFile::Empty(),), background_color : None,
                size : "1".to_string(), borders : BordersFile::NONE, border_style : None,
                border_active_style : None, border_title : Vec::new(),
                border_title_position : BorderTitlePosition::Top, border_title_alignment
                : Alignment::Left, border_symbols : BorderSymbolsFile::default(), },
                SubPaneFile { collapse_below : None, shrink_below : None, window_sizes :
                Vec::new(), size : "100%".to_string(), background_color : None, borders :
                BordersFile::NONE, border_style : None, border_active_style : None,
                border_title : Vec::new(), border_title_position :
                BorderTitlePosition::Top, border_title_alignment : Alignment::Left,
                border_symbols : BorderSymbolsFile::default(), pane :
                PaneOrSplitFile::Pane(PaneTypeFile::QueueHeader(),), },], }, },
                SubPaneFile { collapse_below : None, shrink_below : None, window_sizes :
                Vec::new(), size : "100%".to_string(), background_color : None, borders :
                BordersFile::LEFT | BordersFile::RIGHT | BordersFile::BOTTOM,
                border_style : None, border_active_style : None, border_title :
                Vec::new(), border_title_position : BorderTitlePosition::Top,
                border_title_alignment : Alignment::Left, border_symbols :
                BorderSymbolsFile::Rounded, pane : PaneOrSplitFile::Split { direction :
                DirectionFile::Horizontal, borders : BordersFile::NONE, panes :
                vec![SubPaneFile { collapse_below : None, shrink_below : None,
                window_sizes : Vec::new(), pane :
                PaneOrSplitFile::Pane(PaneTypeFile::Empty(),), background_color : None,
                ...
                BorderTitlePosition::Top, border_title_alignment : Alignment::Left,
                border_symbols : BorderSymbolsFile::default(), pane :
                PaneOrSplitFile::Pane(PaneTypeFile::Queue,), },], }, },], }, },], }, },
                #[cfg(debug_assertions)] #[cfg(not(test))] TabFile { name : "Radio"
                .to_string(), border_type : BorderTypeFile::None, pane :
                ...
                border_title_alignment : Alignment::Left, border_symbols :
                BorderSymbolsFile::Rounded, pane :
                PaneOrSplitFile::Pane(PaneTypeFile::Radio { tree :
                TreeBrowserArgs::default(), }), }], }, }, #[cfg(debug_assertions)]
                #[cfg(not(test))] TabFile { name : "Jellyfin".to_string(), border_type :
                BorderTypeFile::None, pane : PaneOrSplitFile::Split { borders :
                BordersFile::NONE, direction : DirectionFile::Vertical, panes :
                vec![SubPaneFile { collapse_below : None, shrink_below : None,
                window_sizes : Vec::new(), size : "100%".to_string(), background_color :
                None, borders : BordersFile::ALL, border_style : None,
                border_active_style : None, border_title : Vec::new(),
                border_title_position : BorderTitlePosition::Top, border_title_alignment
                : Alignment::Left, border_symbols : BorderSymbolsFile::Rounded, pane :
                PaneOrSplitFile::Pane(PaneTypeFile::Jellyfin { tree :
                TreeBrowserArgs::default(), }), }], }, }, TabFile { name : "MPD"
                .to_string(), border_type : BorderTypeFile::None, pane :
                PaneOrSplitFile::Split { borders : BordersFile::NONE, direction :
                DirectionFile::Vertical, panes : vec![SubPaneFile { collapse_below :
                None, shrink_below : None, window_sizes : Vec::new(), size : "100%"
                ...
                border_title_alignment : Alignment::Left, border_symbols :
                BorderSymbolsFile::Rounded, pane :
                PaneOrSplitFile::Pane(PaneTypeFile::Directories { tree :
                TreeBrowserArgs::default(), }), }], }, }, TabFile { name : "Artists"
                .to_string(), border_type : BorderTypeFile::None, pane :
                PaneOrSplitFile::Split { borders : BordersFile::NONE, direction :
                DirectionFile::Vertical, panes : vec![SubPaneFile { collapse_below :
                None, shrink_below : None, window_sizes : Vec::new(), size : "100%"
                ...
                border_title_alignment : Alignment::Left, border_symbols :
                BorderSymbolsFile::Rounded, pane :
                PaneOrSplitFile::Pane(PaneTypeFile::Artists), }], }, }, TabFile { name :
                "Album Artists".to_string(), border_type : BorderTypeFile::None, pane :
                PaneOrSplitFile::Split { borders : BordersFile::NONE, direction :
                DirectionFile::Vertical, panes : vec![SubPaneFile { collapse_below :
                None, shrink_below : None, window_sizes : Vec::new(), size : "100%"
                .to_string(), background_color : None, borders : BordersFile::ALL,
                ...
                border_title_alignment : Alignment::Left, border_symbols :
                BorderSymbolsFile::Rounded, pane :
                PaneOrSplitFile::Pane(PaneTypeFile::AlbumArtists), }], }, }, TabFile {
                name : "Albums".to_string(), border_type : BorderTypeFile::None, pane :
                PaneOrSplitFile::Split { borders : BordersFile::NONE, direction :
                DirectionFile::Vertical, panes : vec![SubPaneFile { collapse_below :
                None, shrink_below : None, window_sizes : Vec::new(), size : "100%"
                .to_string(), background_color : None, borders : BordersFile::ALL,
                ...
                border_title_alignment : Alignment::Left, border_symbols :
                BorderSymbolsFile::Rounded, pane :
                PaneOrSplitFile::Pane(PaneTypeFile::Albums), }], }, }, TabFile { name :
                "Playlists".to_string(), border_type : BorderTypeFile::None, pane :
                PaneOrSplitFile::Split { borders : BordersFile::NONE, direction :
                DirectionFile::Vertical, panes : vec![SubPaneFile { collapse_below :
                None, shrink_below : None, window_sizes : Vec::new(), size : "100%"
                .to_string(), background_color : None, borders : BordersFile::ALL,
...
pub(crate) fn validate_tabs(layout: &SizedPaneOrSplit, tabs: &Tabs) -> Result<()> {
    let layout_panes = layout.panes_iter().collect_vec();
        ...
        layout_panes.iter().filter(| pane | pane.pane == PaneType::TabContent).count() ==
        1, "Layout must contain exactly one TabContent pane"
    );
    let all_tab_panes = tabs
        .tabs
        .values()
    ...
    let panes_in_both_tabs_and_layout = all_tab_panes
        ...
        .filter(|pane| {
            !PANES_ALLOWED_IN_BOTH_TAB_AND_LAYOUT
                .contains(&PaneTypeDiscriminants::from(&pane.pane))
        })
